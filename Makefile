...
#    Updated: 2021/03/04 19:18:32 by minsunki         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS_B		= ft_lstnew.c ft_lstadd_front.c ft_lstsize.c ft_lstadd_back.c ft_lstdelone.c ft_lstclear.c ft_lstiter.c ft_lstmap.c ft_lstlast.c
GCC			= gcc
